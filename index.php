						...
						<ul class="menu-navigation__list nav navbar-nav">
							...
							<li><a href="fleet.html">Fleet <i class="icon-arrow-down-sign-to-navigate"></i></a>
								<ul class="sub-menu dropdown-menu">
									<li><a href="fleet-second.jsp">Cars</a></li>
									<li><a href="bike.jsp">Bikes <i class="icon-arrow-down-sign-to-navigate"></i></a>
					...
					<!-- Left nav -->
						<ul class="menu-navigation__list nav navbar-nav">
							...
							<li><a href="fleet.html" data-hover="Fleet">Fleet <i class="icon-arrow-down-sign-to-navigate"></i></a>
								<ul class="sub-menu dropdown-menu">
									<li><a href="fleet-second.jsp">Cars</a></li>
									<li><a href="bike.jsp">Bikes </a>
										
								</ul>
							</li>
							<li><a href="services.html" data-hover="Services">Services</a>
	...
	<main id="page-content">
		...
		<div class="slider-wrapper theme-default">
			<div id="slider" class="nivoSlider"> 
				<img src="assets/images/gallery/mb.jpg" title="#htmlcaption1" data-thumb="assets/images/gallery/mb.jpeg" alt="" /> 
				<img src="assets/images/gallery/mb.jpg" title="#htmlcaption2" data-thumb="assets/images/gallery/mb.jpeg" alt="" /> 
				...
				<div class="nivo-caption__inner">
					<div class="text">
						...
						<div class="book-form__btn">
								<a type="submit" class="btn" href="customer_login_register.php">BOOK NOW</a><!-- data-remodal-target="modal" value="BOOK NOW">-->
                                                      </div>
			...
			<div id="htmlcaption2" class="nivo-caption">
				<div class="nivo-caption__inner left-side">
					<div class="text">
						...
						<h1 class="showtext showtext__h1">Book your<br> Perfect Ride On-</h1>
						<span class="showtext showtext__link"><a href="#">BOOK MY CAR</a></span><br>
                                                <span class="showtext showtext__link"><a href="#">BOOK MY BIKE</a></span>
		...
		<div class="parallax_box">
			<figure class="thumbnail move_img wow slideInLeft" data-wow-delay="0.1s"></figure>
                                                 
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-lg-6 col-lg-push-6"> 
						<h1>Welcome</h1>
						<p>Hiring a car or a bike just got easier with the reliable service of Book My Ride! We offer the finest choice of vehicles ranging from economy to luxury.</p>
						<p>We have tied up with renowned vehicle rental brands so that we can provide our customers with the most economic vehicle rental deals along with world class customer service. </p>
		...
		<section class="car-info-box" data-wow-duration="1s" data-wow-delay="1s"> 
			<div class="car-info-box__description">
				<div class="desc-inner">
					<h1>Car or Bike Hire</h1>
					<span class="text-link">Search for the best deals on Book My Ride</span>
					<p>Find cheap car and bike hire fast and hit the road happy with Book My Ride. Search the world’s top car hire companies. Instantly compare prices. Then book direct with the vehicle rental company of your choice. It’s so easy.  We search thousands of destinations and compare thousands of car hire deals to help you find your perfect drive at a low price. </p>
				</div>
			</div>
			<figure class="car-info-box__thumb has-second-img">
				<img src="assets/images/banner.jpeg" alt="" class="first-fade">
				<img src="assets/images/banner.jpeg" alt="" class="second-fade">
			</figure>
		</section> 
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-6">
						<div class="copyright">&copy; 2020 | <a href="#">Privacy Policy</a> | <a href="#">Rental policy</a></div>
					</div>
					<div class="col-xs-12 col-md-6"> 
						<div class="social-list">
							<ul class="social-list__icons">
